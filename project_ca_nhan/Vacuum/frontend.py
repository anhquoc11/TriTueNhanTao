...
from algorithms import IDF as idf
from algorithms import UCS as ucs
from algorithms import IDA_sao as ida
from algorithms import SA as sa
from algorithms import Local_Beam_Search as local_beam
from algorithms import Simple_Hill_Climbing as hill_simple
from algorithms import Steepest_hill_climbing as hill_steep
from algorithms import Random_Restart_Hill_Climbing as hill_random
from algorithms import Stochastic_Hill_Climbing as hill_random_init
from algorithms import BFS_MTPT as bfs_mtpt
from algorithms import And_Or_search as and_or
...
ALGORITHM_NAMES = ["UCS", "BFS", "DFS", "IDF", "IDA_sao", "AND_OR", "LD_ĐG", "LD_DN", "LD_NN", "LD_NN_KT", "SA", "LBS", "BFS_MTPT"]
...
algorithms = {
    ...
    "IDF": run_idf,
    "IDA_sao": ida.IDA_sao,
    "LD_ĐG": hill_simple.Simple_Hill_Climbing,
    "LD_DN": hill_steep.Steepest_hill_climbing,
    "LD_NN": hill_random.Random_Restart_Hill_Climbing,
    "LD_NN_KT": hill_random_init.Stochastic_Hill_Climbing,
    "SA": sa.SA,
    "LBS": local_beam.Local_Beam_Search,
    "AND_OR": and_or.And_Or_Search,
...
while running_app:
    ...
    draw_text(f"Speed delay: {speed_delay}", GRID_X + 420, CONTROL_BUTTON_Y + BUTTON_HEIGHT + 10)
    draw_text(f"Action: {actions[step-1] if actions and step > 0 else 'N/A'}", GRID_X + 420, CONTROL_BUTTON_Y + BUTTON_HEIGHT + 35)
