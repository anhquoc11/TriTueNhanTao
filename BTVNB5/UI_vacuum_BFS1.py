...
def draw_right():
    ...
    # INFO PANEL
    pygame.draw.rect(screen, LIGHT, (RIGHT_X, 290, RIGHT_W, 150))
    pygame.draw.rect(screen, BLACK, (RIGHT_X, 290, RIGHT_W, 150), 2)
    ...
    # FINAL STATE
    screen.blit(font.render("FINAL STATE", True, BLACK), (RIGHT_X + 10, 470))
